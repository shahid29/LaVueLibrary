        ...
        <div class="col-md-8 ">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Edit Your Borrow Details</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <select id="exampleInputCat" v-model="form.user_id" type="text" name="user_id"
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            axios.get(`/getborrowInfo/${this.$route.params.id}`)
                .then((response)=>{
            ...
            Update(){
                this.form.post(`/update/${this.$route.params.id}`)
                    .then((response)=>{
                        ...
                        toast({
                            type: 'success',
                            title: 'Borrow Details Update Successfully'
                        })
                    })
            }
        }
